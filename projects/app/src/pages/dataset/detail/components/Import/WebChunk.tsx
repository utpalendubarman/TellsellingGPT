...
import { useImportStore, WebSelectorContainer, PreviewFileOrChunk } from './Provider';
import { useTranslation } from 'next-i18next';

const fileExtension = '.txt, .docx, .pdf, .md, .html';

const WebChunkImport = () => {
  ...
  return (
    <Box display={['block', 'flex']} h={['auto', '100%']}>
      <WebSelectorContainer fileExtension={fileExtension}>
        {/* chunk size */}
