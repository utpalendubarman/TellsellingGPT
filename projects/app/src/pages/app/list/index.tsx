...
const MyApps = () => {
  ...
  return (
    <PageContainer isLoading={isFetching} insertProps={{ px: [5, '48px'] }}>
      <Flex pt={[4, '30px']} alignItems={'center'}>
        <Box flex={1} letterSpacing={1} fontSize={['20px', '24px']} color={'myGray.900'}>
          {t('app.My Apps')}
        </Box>
        <Button
          style={{ float: 'right' }}
          ...
          >
            ...
            >
              ...
              <Box
                ...
                color={'myGray.600'}
              >
                {app.intro || 'I havent written this application yet ~'}
              </Box>
      ...
      {myApps.length === 0 && (
        <Flex mt={'35vh'} flexDirection={'column'} alignItems={'center'}>
          ...
          <Box mt={2} color={'myGray.500'}>
            Haven't applied yet, go and create one!
          </Box>
        </Flex>
      )}
      <ConfirmModal />
